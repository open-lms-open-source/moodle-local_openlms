...
$PAGE->set_url('/local/openlms/notification/delete.php', ['id' => $notification->id]);
$PAGE->set_pagelayout('admin');
$PAGE->set_heading(get_string('notification_delete', 'local_openlms'));
$PAGE->set_title(get_string('notification_delete', 'local_openlms'));
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('notification_delete', 'local_openlms'));
echo $form->render();
echo $OUTPUT->footer();
