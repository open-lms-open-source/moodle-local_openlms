...
/**
 * Form that allows admins to override or disable hook callbacks.
 *
 ...
 */
class hook_callback_override extends \moodleform {
    /**
     * Hook overriding form.
     * @return void
     */
    public function definition() {
        $mform = $this->_form;

        $mform->addElement('hidden', 'action', 'override');
        ...
        $this->add_action_buttons(true, get_string('hookoverride', 'local_openlms'));
    }
}
